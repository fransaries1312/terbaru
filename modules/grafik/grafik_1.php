            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal">
                        ...
                        <div class="row form-group">
                            <div class="col col-md-2"><label for="select" class=" form-control-label">Nama Obat</label></div>
                            <div class="col-md-3">
                    ...
                    if (!empty($_GET['id_obat']) || !empty($_GET['id_obat1'])) {
...
//                labels: ["Januari", "Februari", "Maret", "April", "Mei", "Juni", "Juli", "Agustus", "September", "Oktober", "November", "Desember"],
                ...
                datasets: [ {
                        ...
                        pointBackgroundColor: 'rgba(40,167,69,0.75)',
                            ...
                            //label: "all",
                            //backgroundColor: 'transparent',
                            //borderColor: 'rgba(100,200,50,0.75)',
                            //borderWidth: 3.5,
                            //pointStyle: 'circle',
                            //pointRadius: 5,
                            //pointBorderColor: 'transparent',
                            //pointBackgroundColor: 'rgba(100,200,50,0.75)',
                            //},
                ]
            },
            options: {
